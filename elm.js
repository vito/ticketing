...
Elm.Ticketing = Elm.Ticketing || {};
Elm.Ticketing.make = function (_elm) {
   "use strict";
   _elm.Ticketing = _elm.Ticketing || {};
   if (_elm.Ticketing.values) return _elm.Ticketing.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Effects = Elm.Effects.make(_elm),
   ...
   var viewRepo = function (repo) {
      return _U.list([A2($Html.dt,
                     ...
                     ,A2($Html.dd,
                     _U.list([]),
                     _U.list([$Html.text($Basics.toString(repo.openIssues))]))]);
   };
   var hasIssues = function (repo) {
   ...
   var view = F2(function (address,model) {
      ...
      if (_p0.ctor === "Just") {
            ...
            _U.list([A2($Html.h1,
                    ...
                    $Basics.toString($List.sum(A2($List.map,
                    function (_) {
                       return _.openIssues;
                    },
                    _p1))),
   ...
   var ReposFetched = function (a) {
      return {ctor: "ReposFetched",_0: a};
   };
   var Repo = F2(function (a,b) {
      return {name: a,openIssues: b};
   });
   var decodeRepos = $Json$Decode.list(A3($Json$Decode.object2,
   Repo,
   ...
   app.tasks);
   return _elm.Ticketing.values = {_op: _op
                                  ,app: app
                                  ,main: main
                                  ,Model: Model
                                  ,Repo: Repo
